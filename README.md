# phat-trien-ung-dung-da-nen-tang

Định nghĩa các thư mục trong project 
...
```
cd existing_repo
git remote add origin https://gitlab.com/fbittq/phat-trien-ung-dung-da-nen-tang.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fbittq/phat-trien-ung-dung-da-nen-tang/-/settings/integrations)
